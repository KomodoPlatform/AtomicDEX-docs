...
For each `coin`, Komodo software requires the user/developer to set the `mm2` parameter. This can be achieved either in the [coins](../atomicdex/atomicdex-tutorials/atomicdex-walkthrough.html#setting-up-coin-list) for more details), or via the [electrum](../atomicdex/atomicdex-api.html#electrum) and [enable](../atomicdex/atomicdex-api.html#enable) methods.
...
Set the value of the `mm2` parameter in the [coins](../atomicdex/atomicdex-tutorials/atomicdex-walkthrough.html#setting-up-coin-list) file as follows:
...
[Link to `mm2` explanatory section](../atomicdex/atomicdex-api.html#notes-on-the-mm2-parameter)
...
This method generates a raw transaction which should then be broadcast using [send_raw_transaction](../atomicdex/atomicdex-api.html#send-raw-transaction).
